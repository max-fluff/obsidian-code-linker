...
// folder is a compact indented row below it with a remove button; a full-width
// input with autocomplete and an add button sits at the bottom. Storage stays a
// "\n"-joined string (splitLines reads it unchanged), so this is a pure UI swap —
// no migration. Callers pass their own CSS prefix, labels and suggest source.
